...
describe("SportsPredictionGame Unit Tests", async function () {
  ...
  describe("Claim", () => {
    ...
    it("should split winnings between results", async () => {
      ...
      const [owner, ...users] = await ethers.getSigners(); // Destructure the signers here

      // Now you can use owner and users in your test
      console.log("Owner address:", owner.address);
      console.log("User 0 address:", users[0]); // This should now be defined

      
      // const signers = await ethers.getSigners();
      // console.log("signers",signers); // Check the output here

      // console.log("user 0",users[0])
      // const [myaccount] = await ethers.getSigners()
      // console.log("myaccount",myaccount.address)
      // console.log("owner",owner.address)
      // await sportsPredictionGame.connect(myaccount).predict(gameId, result, { value: wager })
      ...
      // await expect(() => sportsPredictionGame.connect(myaccount).claim(gameId, false)).to.changeEtherBalance(
      //   // users[0],
      //   myaccount,
      //   wager.mul(2)
      // )
